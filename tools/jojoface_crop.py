...
def main(model_path, data_path, save_path, batch_size: int,
  ...
  movie_paths = list(data_path.glob('*.mp4'))
  save_paths = [save_path / f'{i:02d}' for i in range(len(movie_paths))]
...
if __name__ == "__main__":
  ...
  parser.add_argument('--data_path', type=str, help='photo folder path',
                      default='/media/zqh/Documents/JOJO4')
  ...
  parser.add_argument('--skip_frame', type=int, help='skip frame num', default=10)
  parser.add_argument('--ignore_size', type=int, help='minimum face size', default=200)
  args = parser.parse_args()

  main(args.model_path, args.data_path, args.save_path,
